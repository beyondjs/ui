...
import { Button, Dialog, Field, FocusedForm, Header, NotificationEntry, NotificationInbox, Picker, Collection, Help, Tooltip, ActionMenu, Select, Choices, useConfirm, useBusy, useToaster, type NotificationAdapter, type PickerHandle } from '@beyond-js/ui/react';
...
export function Screen() {
	...
	return (
		<>
			<Header brand={{ label: 'Beyond', href: '/' }} context={[{ label: 'Northwind', href: '/o' }]} notifications={<NotificationEntry adapter={adapter} href="#/notifications" locale="es" />} account={<span>Ana</span>} toggle={{ controls: 'rail', expanded: open, onChange: setOpen }} />
